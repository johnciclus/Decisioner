...
(defproject dataset-viewer "0.1.0"
  ...
  :profiles {:dev {:cljsbuild
                   {:builds {:client {:source-paths ["devsrc"]
                                      :compiler     {:preloads [devtools.preload]
                                                     :main "datasetViewer.dev"
                                                     :asset-path "assets/dataset-viewer/js"
                                                     :optimizations :none
                                                     :source-map true
  ...
  :clean-targets ^{:protect false} ["js"]

  :cljsbuild {:builds {:client {:source-paths ["src"]
                                :compiler     {:output-dir "js"
                                               :output-to  "js/client.js"}}}})
  ;:typescript {
  ;             :sources ["../javascripts/datasetViewer/bower_components/dicom-roi-editor/ts/*.ts"]
  ;             :excludes [""]
  ;             ;:watch true
  ;             :out "../javascripts/datasetViewer/bower_components/dicom-roi-editor/js/app.js"
  ;             ;:out-dir "target"
  ;             ;:module :amd
  ;             :declaration true
  ;             :source-map true
